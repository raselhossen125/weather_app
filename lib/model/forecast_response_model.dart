...
class ForecastResponseModel {
  ...
  late final int cnt;
  late final List<ForecastItem> list;
  ...
  ForecastResponseModel.fromJson(Map<String, dynamic> json){
    ...
    cnt = json['cnt'];
    list = ForecastItem.from(json['list']).map((e)=>ForecastItem.fromJson(e)).toList();
...
class ForecastItem {
  ...
  ForecastItem.fromJson(Map<String, dynamic> json){
    ...
    weather = ForecastItem.from(json['weather']).map((e)=>Weather.fromJson(e)).toList();
